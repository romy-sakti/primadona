...
// Dynamically include all module routes
$moduleRouteFiles = glob(base_path('routes/modules/*.php'));
...
Route::post('dashboard', [DashboardController::class, 'post'])->middleware('auth');
