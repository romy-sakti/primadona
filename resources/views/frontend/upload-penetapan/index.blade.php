    ...
    <div class="container">
        <div class="row justify-content-center">
                    ...
                    <div class="services-details-content">
                        ...
                        <div class="card border-0 shadow-sm mt-4">
                            <div class="card-body p-4">
                                ...
                                @if($penetapanFiles->isNotEmpty())
                                <div class="mt-4">
                                    <h5>File Penetapan yang Telah Diupload</h5>
                                    <div class="d-flex flex-wrap gap-2">
                                        @foreach($penetapanFiles as $file)
                                        <a href="{{ asset('uploads/penetapan/' . $file->file_penetapan) }}"
                                            target="_blank" class="default-btn-one">
            ...
            <div class="col-12 text-right mt-4">
                <form id="logout-form" action="{{ route('logout-portal') }}" method="POST" style="display: none;">
                    @csrf
                </form>
