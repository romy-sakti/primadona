<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-brand">
            ...
            @else
            <a href="{{ url('') }}" style="font-size: 25px;">{{ $_app_name }}</a>
            @endif
        </div>

        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ url('') }}" style="font-size: 25px;">{{ $_app_name_mobile }}</a>
        </div>
            ...
            <li class="nav-item dropdown @if ($_is_active) active @endif">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li @if (Request::is($_child_menu->is_active_if_url_includes)) class="active" @endif>
                        <a class="nav-link" href="{{ $_child_menu->fix_url }}" @if ($_child_menu->is_blank)
                            target="_blank" @endif>
