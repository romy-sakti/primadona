...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-balance-scale"></i> {{ $title }}</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ $item->file_url }}" target="_blank" class="btn btn-info btn-sm">
                                    ...
                                    <td>
                                        ...
                                        route('peraturans.edit', [$item->id])])
                                        @endif
                                        @if ($canDelete)
                                        @include('stisla.includes.forms.buttons.btn-delete', ['link' =>
                                        route('peraturans.destroy', [$item->id])])
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
