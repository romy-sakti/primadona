...
<div class="section-body">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fa fa-fas fa-calendar-check"></i> {{ $title }}</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        route('jadwalsidangkelilings.edit', [$item->id])])
                                        @endif
                                        @if ($canDelete)
                                        @include('stisla.includes.forms.buttons.btn-delete', ['link' =>
                                        route('jadwalsidangkelilings.destroy', [$item->id])])
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel{{ $item->id }}">Detail Jadwal Sidang Keliling</h5>
